    ...
    public ArrayList<String> getAllExistedPeriod(long factoryId) {
        ...
        for (int count = 0; count < allVoucherList.size(); count++) {
            ...
            if (!resultList.contains(onePeriod)) {
                ...
                switch (onePeriod.substring(5)) {
                    case "第1期":
                        tempList[0] = onePeriod;
                        break;
                    case "第2期":
                        tempList[1] = onePeriod;
                        break;
                    case "第3期":
                        tempList[2] = onePeriod;
                        break;
                    case "第4期":
                        tempList[3] = onePeriod;
                        break;
                    case "第5期":
                        tempList[4] = onePeriod;
                        break;
                    case "第6期":
                        tempList[5] = onePeriod;
                        break;
                    case "第7期":
                        tempList[6] = onePeriod;
                        break;
                    case "第8期":
                        tempList[7] = onePeriod;
                        break;
                    case "第9期":
                        tempList[8] = onePeriod;
                        break;
                    case "第10期":
                        tempList[9] = onePeriod;
                        break;
                    case "第11期":
                        tempList[10] = onePeriod;;
                        break;
                    case "第12期":
                        tempList[11] = onePeriod;
                        break;
                }
            }
